  ...
  return <main className="console-shell">
    ...
    <section className="console-main">
      ...
      <div className="console-content">
        {activeView === 'new' && <>
          <section className="hero-row"><div><p className="eyebrow">DOCUMENT INTELLIGENCE</p><h2>Verify the document.<br /><em>Trust the evidence.</em></h2><p className="hero-copy">Upload an Indian identity document image, screenshot, or PDF. The console validates the file, reconciles OCR and QR/MRZ evidence, then produces a conservative review score.</p></div><div className="hero-mark">S<span>01</span></div></section>
