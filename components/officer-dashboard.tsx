  ...
  return <main className="console-shell">
    ...
    <section className="console-main">
      ...
      <div className="console-content">
        {activeView === 'new' && <>
          <section className="hero-row"><div><p className="eyebrow">DOCUMENT INTELLIGENCE</p><h2>Verify the document.<br /><em>Trust the evidence.</em></h2><p className="hero-copy">Upload a government document image, screenshot, or PDF. The node validates the file locally, then OCR and AI analysis produce a conservative evidence score.</p></div><VerificationDepth active={analyzing} /><div className="hero-mark">S<span>01</span></div></section>
